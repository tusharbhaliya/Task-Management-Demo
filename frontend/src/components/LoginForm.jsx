    ...
    <>
      <form className='m-auto my-16 max-w-[500px] bg-white p-8 border-2 shadow-md rounded-md'>
          <>
            ...
            <div className="mb-4">
              <label htmlFor="email" className="after:content-['*'] after:ml-0.5 after:text-red-500">EmailId</label>
            ...
            <div className='pt-4'>
              <Link to="/signup" className='text-blue-400'>Don't have an account? Signup</Link>
            </div>
          </>
      </form>
    </>
